...
export function rootAgentInstructions(): string {
	return `<multi_agent_role>Use spawn_agent for independent delegated work. Completion notices contain no answer; call list_agents(include_results=true) only when a result is needed.</multi_agent_role>`;
}
